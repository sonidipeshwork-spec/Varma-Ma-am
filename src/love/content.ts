...
export const NAV = [
  ...
  { id: "confession", label: "Love confession" },
...
export const QUALITIES = [
  { img: img3, title: "Your light", line: "You walk in and the room becomes softer, warmer, easier to breathe in." },
  { img: img4, title: "Your kindness", line: "The quiet compassion in small gestures. A heart that is genuinely rare." },
  { img: img5, title: "Your smile", line: "A sunrise that dissolves heavy thoughts. The melody I look for first." },
  { img: img6, title: "Your calm", line: "Thinking of you is an anchor. In a noisy world, you are sanctuary." },
  { img: img7, title: "Your presence", line: "My favorite place is not a city. It is every second spent with you." },
  { img: img8, title: "Your magic", line: "You are the muse. You paint colors I did not know the world had." },
] as const;
